define(['managerAPI',
	...
	init_data_pipe(API, 'DQwxMuFQBCJT',  {file_type:'csv'});	
    ...
    if (raceSet == 'a') {
        blackLabels.push('Black Person');
        whiteLabels.push('White Person');
    } else {
    ...
    API.addTasksSet({
        ...
        [{ 
            ...
            type:'redirect', name:'redirecting', url: 'https://unioflincoln.questionpro.eu/t/AB3uymDZB3wIQF' 
        }],
